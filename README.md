...
* [7.装饰器](#7)
* [8.使用生成器替代列表生成式](#8)
* [9.使用生成器替代直接返回列表的函数](#9)
* [10.实例方法、类方法与静态方法](#10)
* [11.使用@property绑定属性](#11)
* [12.使用`__`进行变量私有化](#12)

Python一些比较高阶的使用技巧


### <span id="1">1. Pythonic</span>
...
### 7. <span id="7">装饰器</span>


### 8. <span id="8">使用生成器替代列表生成式</span>
...
### 9. <span id="9">使用生成器替代直接返回列表的函数</span>
...
### 10. <span id="nametuple使用">nametuple使用</span>
...
### 10. <span id="10">实例方法、类方法与静态方法</span>
...
### 11. <span id="11">使用@property绑定属性</span>



### 12. <span id="12">使用`__`进行变量私有化</span>
